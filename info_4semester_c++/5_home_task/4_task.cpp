...
int main()
{
    ...
    control.addButton(new Button(window, {40, 560, 240, 40}, font, "Random Colors"), new RandomAllColorsCommand(pool));
    control.addButton(new Button(window, {40, 620, 240, 40}, font, "Clear All"), new ClearAllShapesCommand(pool));
